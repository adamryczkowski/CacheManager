...
== TODO
- [ ] Fix bug: read cache ignores storage prefix.
- [ ] Add two better implementations of ObjectPromise: one that pickles the object, and the other that JSON-izes it (using pydantic).
